(function() {
  ...
  {id: i++, content: 'HTML5', start: '2010-01-01', type: 'box', className: 'green important', group: 1},  
  ...
  {id: i++, content: 'Adobe Flash - ActionScript', start: '1997-01-01', type: 'range', className: 'green', end: '2009-12-31', type: 'range', className: 'browser flash', group: 2},  
  ...
  {id: i++, content: 'Vue.js', start: '2014-01-01', type: 'box', className: 'orange', group: 3},
  ...
  var options = {orientation: {axis: 'both', items: 'top'}, type: 'point'};
