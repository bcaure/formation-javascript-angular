(function() {
  ...
  var items = new vis.DataSet([
    ...
    {id: i++, content: 'WebLogic', start: '1998-01-01', group: 2, className: 'important'},
    {id: i++, content: 'Tomcat', start: '1999-01-01', group: 2, className: 'orange important'},
    {id: i++, content: 'JBoss', start: '2001-01-01', group: 2},
    {id: i++, content: 'Websphere', start: '1998-06-01', group: 2, className: 'important'},
    ...
    {id: i++, content: 'Java 1.3', start: '2000-06-01', end: '2002-02-01', group: 1, className: 'magenta important'},
    ...
    {id: i++, content: 'J2EE', start: '1999-12-12', group: 3, className: 'important'},
    {id: i++, content: 'JEE5', start: '2006-06-01', group: 3, className: 'important'},
    ...
    {id: i++, content: 'Struts', start: '2000-05-01', group: 3, className: 'important'},
    ...
    {id: i++, content: 'Hadoop', start: '2011-10-11', group: 4, className: 'important'},
    {id: i++, content: 'Kafka', start: '2011-01-01', group: 4},
    {id: i++, content: 'Log4j', start: '2000-01-01', group: 4, className: 'important'},
    ...
    {id: i++, content: 'Scala', start: '2004-01-20', group: 5, className: 'important'},
    {id: i++, content: 'Groovy', start: '2007-01-02', group: 5, className: 'important'},
